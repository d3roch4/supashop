...
class Auth0AccountService implements AuthenticationService {
  @override
  ...
  Future<Account?> loadUser() async {
    ...
    if (_client == null) return null;
    currentAccount = tokenToUser(_client?.credentials.idToken ?? '');
  ...
  Future<Account?> signIn(
    ...
    currentAccount = tokenToUser(client.credentials.idToken ?? '');
    return currentAccount;
  }
